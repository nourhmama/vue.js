...
onMounted(() => {
  ...
  // Vérification si currentUser est correctement défini
  if (!currentUser || !currentUser.first_name || !currentUser.last_name) {
    console.error("Erreur: currentUser n'est pas correctement défini"); 
  }
});
</script>
<template>
  ...
  <div>
    <div class="d-flex align-center pa-5">
      <v-avatar size="32" class="mr-2">
        <img src="@/assets/images/users/avatar-1.png" width="32" alt="{{ currentUser.first_name }}" />
      </v-avatar>
      <div>
        <h6 class="text-h6 mb-0">{{ currentUser.first_name }} {{ currentUser.last_name }}</h6>
